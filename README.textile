...
* <code>Routes.show_account_path('Doe', 'John')</code>, or
* <code>Routes.show_account_path({first_name: 'John', last_name: 'Doe'})</code>

Becoming <code>/account/Doe/John</code>.

Finally, extra parameters not specified by the route will be placed in the URL query string:

* <code>Routes.show_account_path('{first_name: 'John', last_name: 'Doe', age: 42})</code>

Becoming <code>/account/Doe/John?age=42</code>.
